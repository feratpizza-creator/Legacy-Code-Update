...
const STR: Record<UiLang, Record<string, string>> = {
  ...
  ar: {
    ...
    whatToLearn: "ما اللغة التي تريد تعلمها؟",
    whatIsYourNativeLanguage: "ما لغتك الأم؟",
    ...
    whatToLearn: "Mitä kieltä haluat oppia?",
    whatIsYourNativeLanguage: "Mikä on äidinkielesi?",
  ...
  es: {
    ...
    whatIsYourNativeLanguage: "¿Cuál es tu idioma nativo?",
  ...
  fr: {
    ...
    whatToLearn: "Quelle langue voulez-vous apprendre ?",
    whatIsYourNativeLanguage: "Quelle est votre langue maternelle ?",
